...
public class GhostHandlerDisplay implements IGhostIngredientHandler<DisplayBlockScreen>  {

    @Override
    public <I> List<Target<I>> getTargetsTyped(DisplayBlockScreen screen, ITypedIngredient<I> ingredient, boolean doStart) {
