...
import com.furglitch.vendingblock.gui.trade.FilterSlot;
...
public class VendorAdminMenu extends AbstractContainerMenu {
    ...
    public VendorAdminMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(MenuRegistry.VENDOR_ADMIN_MENU.get(), containerId);
